...
from service.chart_generator import generate_advanced_charts
from service.generate_html_report import generate_html_report
...
def main():
            ...
            if simple_code in realtime_map:
                ...
                if full_code in history_data_map:
                    ...
                    if last_date_str != today_str:
                        ...
                        # Update today's data in history if it exists (it might be partial)
    ...
    csv_path = os.path.join(OUTPUT_DIR, f"global_analysis_details_{date_str}.csv")
    
    print(f"Saving results to {csv_path}...")
    df_block.to_csv(csv_path, index=False, encoding='utf-8-sig')
